...
public class  ShoucangHttpAdapter {

	
	public static ArrayList<Shoucang> getAllShoucangList(long lastId, int pageNo, String flag) throws Exception{
		String url = Constants.WEB_APP_URL + "shoucang.do?method=list&type=json";
		...
		ArrayList<Shoucang> ret = new ArrayList<Shoucang>();
		for( int i = 0; i != jsonArray.length(); i++){
			JSONObject json = jsonArray.getJSONObject(i);

			Shoucang object = new Shoucang();
...
//	public static ArrayList<Shoucang> getFollowedByType(long lastId, int pageNo,  String news_type ) throws Exception  {
